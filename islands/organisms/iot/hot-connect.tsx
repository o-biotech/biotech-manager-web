...
import { ChevronDownIcon, RenewIcon } from "$fathym/atomic-icons";
import * as signalR from "npm:@microsoft/signalr@8.0.0/dist/browser/signalr.js";
import { Action, classSet } from "@fathym/atomic";
...
export function HotConnect(props: HotConnectProps) {
  if (!IS_BROWSER) {
    return (
      <>
