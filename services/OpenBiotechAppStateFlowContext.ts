import { StateFlow, StateFlowContextService } from "$atomic/state-flow/StateFlowContext.tsx";
...
export class OpenBiotechAppStateFlowContextService extends StateFlowContextService<OpenBiotechAppStateFlow> {
